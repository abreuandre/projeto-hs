          ...
          <Card>
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Row>
                ...
                <ListaValores /* name='selTipoAusencia' */ colFiltro='tipo' placeholder='Selecione o tipo da ausência' label="MOTIVO" lista={TiposAusencia} x={setAusencia} 
                className='pb-md-3' {...field} />
              ...
              <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                      <Input  className='form-control' type="text" placeholder='' required={true} {...field} />
                  )}/>
